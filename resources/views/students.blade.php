    ...
    <div class="flex flex-col justify-center items-center gap-y-10">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-5">
            @foreach ($students as $student)
                <div class="bg-white hover:text-white hover:bg-purple-600 border hover:border-0 p-4 rounded-lg transition-all hover:scale-105 shadow-md hover:shadow-lg cursor-pointer">
